...
export default function Piercings({ images = [], autoplayMs = 2000 }) {
  ...
  return (
    <section className="carousel-section p-10">
      <div className="relative w-full px-4 py-8">
          ...
          >
            <ul ref={trackRef} className="-ml-4 flex gap-4 snap-x snap-mandatory scroll-pl-4 scroll-smooth">
              {images.map((image, index) => (
                ...
                >
                  <div className="relative h-[500px] lg:h-[700px] w-full overflow-hidden rounded-xl">
                    <img
                      src={image.src}
                      alt={image.alt}
        ...
        <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 flex space-x-4 lg:hidden">
          <button
            onClick={goToPrev}
