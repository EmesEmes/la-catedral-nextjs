  ...
  return (
    <section id="work" className="flex flex-col ">
      ...
      >
        {projects.map((project, index) => (
          ...
          >
            ...
            <div
              ...
              className="absolute inset-0 hidden md:block duration-200 md:group-hover:bg-white -z-10 clip-path"
            />
            ...
            <div className="flex justify-between px-10 text-white transition-all duration-500 md:group-hover:px-12 md:group-hover:text-black">
              ...
              <span className="md:size-6 size-5">→</span>
            </div>
            {/* divider */}
            <div className="w-full h-0.5 bg-white/80 md:group-hover:bg-black" />
            {/* framework */}
        ...
        <div
          ref={previewRef}
          className="fixed -top-2/6 left-0 z-50 overflow-hidden border-8 border-sky-700 pointer-events-none  md:block hidden opacity-0"
        >
          {currentIndex !== null && (
            <img
